# Multi-View Interval BRB for Gearbox Fault Diagnosis

> A multi-view belief rule base framework with uncertainty-aware fusion for rotating machinery fault diagnosis.
